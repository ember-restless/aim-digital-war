...
# -*- coding: utf-8 -*-
"""
AIM 数字大战 · 新手教程 总封面（单视频用）v2 —— 干净版：无人物
只有大标题 + 数字 1~9 一行 + 副标题，1920x1080
"""
import os
...
d.text((x0 + 20, y0 + 20), '九章合集', font=cn(34), fill=(255, 255, 255))
